...
input_file = param['filenames']['input'][0]
output_file = param['filenames']['output'][0]

data = pd.read_csv(input_file, encoding=param['settings']['encoding'][0])
...
# Категоризация писем
categorizer = LetterCategorizer(input_file, output_file)
categorizer.run()
